...
original_verify = subprocess.check_output(
    ['git', 'show', '8b1bb9c258850ece527ad30c8f65f17a6f026f6d:.github/workflows/verify-site.yml'], text=True
)
...
for temporary in [
    ...
    Path('.github/workflows/run-ai-gateway-migration.yml'),
    Path('MIGRATION_TRIGGER.md'),
    Path('AI_GATEWAY_MIGRATION_TRIGGER.md'),
