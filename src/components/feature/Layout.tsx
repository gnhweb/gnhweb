...
import UnifiedNavbar from '@/components/feature/UnifiedNavbar';
...
export default function Layout(){
 ...
 const isSpecial=['/faith','/telegram-settings','/bible-pick','/bible-mbti','/event-ideas'].includes(location.pathname);
 ...
 const special=location.pathname==='/faith'?<FaithHubPage/>:location.pathname==='/telegram-settings'?<TelegramSettingsPage/>:location.pathname==='/bible-pick'?<BiblePickEnhanced/>:location.pathname==='/bible-mbti'?<BibleMbtiEnhanced/>:<EventIdeasEnhanced/>;
