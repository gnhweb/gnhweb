...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`sticky top-0 z-40 pt-safe transition-all duration-300 ${scrolled ? 'bg-background-100/95 backdrop-blur-md shadow-sm border-b border-background-200/60 max-md:rounded-b-2xl max-md:shadow-card max-md:bg...` /* preserve existing implementation */}
    </>
  );
}