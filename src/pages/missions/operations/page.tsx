...
export default function MissionsOperationsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    } catch (e) { const message = e instanceof Error ? e.message : String(e); console.error('[MissionOperations] load failed', message); setError(`사명 운영 데이터를 불러오지 못했습니다. ${message || '다시 시도해주세요.'}`); }
