    ...
    return (
      <div className="min-h-screen bg-background-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/notices')} className="text-primary-600 hover:text-primary-700 font-medium cursor-pointer">공지사항 목록으로</button>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-2xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground-950 mb-1">공지사항 수정</h1>
            <p className="text-sm text-foreground-600">기존 공지 내용을 수정합니다</p>
          </div>
