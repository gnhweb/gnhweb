...
export default function WeeklyReportDetail() {
  ...
  if (error || !report) return <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 text-center"><p className="text-foreground-600 mb-4">{error || '보고서를 찾을 수 없습니다'}</p><Link to="/reports/weekly" className="text-sm text-primary-600">목록으로 돌아가기</Link></div>;
