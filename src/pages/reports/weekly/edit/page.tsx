      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <div className="space-y-6">
          <section className="bg-background-100 border border-background-200 rounded-[20px] p-5 md:p-6 space-y-5">
            ...
            <div><h2 className="font-bold">연습일 기록</h2><p className="text-xs text-foreground-600 mt-1">보고서는 연습일별로 각각 저장됩니다.</p></div>
          </section>
          ...
          {practiceEntries.map((entry, index) => (
            <section key={entry.practice_date} className="bg-background-100 border border-background-200 rounded-[20px] p-5 md:p-6 space-y-5">
              <div className="flex items-center justify-between gap-3"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center font-bold">{index + 1}</div><div><h2 className="font-bold">{formatPracticeDate(entry.practice_date)} 연습 기록</h2></div></div></div>
