...
export default function EventReportWrite() {
    ...
    <div className="max-w-2xl mx-auto px-4 md:px-6 py-8 md:py-12">
      ...
      >
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground-950 mb-1">행사 보고서 작성</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="예: 2026 여름 수련회 특송, 청소년 응원 페스티벌 참가 등"
                maxLength={100}
