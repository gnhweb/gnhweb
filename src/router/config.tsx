...
const routes: RouteObject[] = [{
  ...
  children: [
    ...
    { path: "/missions", element: <AuthGuard minRole="member">{withSuspense(<MissionsPage />)}</AuthGuard> },
    { path: "/missions/board", element: <AuthGuard minRole="member">{withSuspense(<MissionBoardPage />)}</AuthGuard> },
    { path: "/missions/leaderboard", element: <AuthGuard minRole="member">{withSuspense(<MissionLeaderboardPage />)}</AuthGuard> },
    { path: "/missions/wall", element: <AuthGuard minRole="member">{withSuspense(<MissionWallPage />)}</AuthGuard> },
